...
export default function DeleteKey({setState}: {setState: () => void}) {
    
    return <button className={styles.bigKey} onClick={setState}>
        {/* Delete icon design is from https://www.nytimes.com/games/wordle/index.html */}
